    ...
    <Fragment>
      <div className="grid grid-cols-3 items-start gap-5">
        <div className="col-span-2 flex items-start gap-4">
          <div className="w-28 h-28 max-sm:w-20 shrink-0 bg-gray-300 p-1 rounded-sm">
            <img
        ...
        <div className="ml-auto">
          ...
          <div className="mt-3">
            <button
              ...
              className="disabled:opacity-65 border border-[#000] bg-white"
            ...
            <button
              ...
              className="border border-[#000] bg-white"
            >
              +
            </button>
          </div>
